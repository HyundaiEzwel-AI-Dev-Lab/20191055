...
import GlobalSearchModal from '@/app/layouts/GlobalSearchModal.vue'
import NotificationModal from '@/app/layouts/NotificationModal.vue'
import MyProjectsModal from '@/app/layouts/MyProjectsModal.vue'
import MyInfoModal from '@/app/layouts/MyInfoModal.vue'
import PasswordResetModal from '@/pages/auth/PasswordResetModal.vue'
import { useAuthStore } from '@/app/stores/auth'
import { useThemeStore } from '@/app/stores/theme'
import { getNotifications } from '@/app/layouts/headerPopups'
