...
import { useLayoutTabs } from '@/app/composables/useLayoutTabs'
import { useProjectRegister } from '@/app/composables/useProjectRegister'
import AppHeader from './AppHeader.vue'
import AppSidebar from './AppSidebar.vue'
import SubTabBar from './SubTabBar.vue'
import ProjectNameRegisterModal from '@/app/layouts/ProjectNameRegisterModal.vue'
import { pinnedItem, integratedMenus, projectMenus } from '@/app/layouts/sidebarMenu'
