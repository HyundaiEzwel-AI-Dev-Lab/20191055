...
function scrollSubTabsByCount(count) {
  subTabBarRef.value?.scrollByCount(count)
}
</script>
  ...
  <div class="app-shell">
    ...
    <div class="app-shell__main">
      ...
      <div v-if="showSubTabs && activeProjectId" class="app-subtab-wrap">
        <button class="app-subtab-wrap__scroll" title="10개 이전" @click="scrollSubTabsByCount(-10)">
        ...
        <button class="app-subtab-wrap__scroll" title="10개 다음" @click="scrollSubTabsByCount(10)">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
